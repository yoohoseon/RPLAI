    ...
    return (
        <Dialog open={open} onOpenChange={setOpen}>
            <DialogTrigger asChild>
                <Button variant="ghost" size="icon" className="w-9 h-9 text-[#8B95A1] hover:text-[#3182F6] hover:bg-[#3182F6]/5 rounded-xl transition-all" title="비밀번호 초기화">
                ...
                <div className="p-10">
                    <DialogHeader className="mb-8">
                        <div className="w-14 h-14 bg-[#3182F6]/5 rounded-2xl flex items-center justify-center mb-6">
                            <KeyRound className="w-7 h-7 text-[#3182F6]" />
                        </div>
