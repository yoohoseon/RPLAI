    ...
    return (
        <div className="flex flex-col h-full bg-white rounded-b-[32px]">
            ...
            <div className="p-8 pb-6">
                <h3 className="text-lg font-bold flex items-center gap-2 text-[#333333]">
            ...
            <div className="p-8 pt-0 flex-1 flex flex-col gap-8">
                ...
                <div className="space-y-6">
                    <div className="flex items-center justify-between">
                        <Label className="text-[15px] font-bold flex items-center gap-2 text-[#333333]">
                            <Calendar className="w-4 h-4 text-[#8B95A1]" />
                            발행 예정 시기
                        </Label>
                        <span className="text-[14px] font-bold text-[#333333] bg-[#F2F4F6]/5 px-4 py-1.5 rounded-full">
                    ...
                    <div className="flex items-center space-x-3 bg-[#F2F4F7] p-5 rounded-2xl border-none hover:bg-[#F2F4F6] transition-colors cursor-pointer group" onClick={() => setIsNewLaunch(!isNewLaunch)}>
                        ...
                        <Label
                            htmlFor="newLaunch"
                            className="text-[14px] font-bold leading-none cursor-pointer flex-1 flex items-center justify-between text-[#4E5968] group-hover:text-[#333333]"
                        >
                                ...
                                <TooltipProvider>
                                    <Tooltip>
                                        <TooltipTrigger asChild>
                                            <Info className="w-4 h-4 text-[#ABB3BB] hover:text-[#333333] transition-colors cursor-help" />
                                        </TooltipTrigger>
                ...
                <div className="space-y-4">
                    ...
                    <Select value={goal} onValueChange={setGoal}>
                        <SelectTrigger className="w-full h-14 bg-[#F2F4F7] border-none rounded-2xl focus:ring-[#3182F6]/20 text-[15px] font-bold text-[#333333]">
                        ...
                        <SelectContent className="rounded-2xl border-none shadow-2xl w-[var(--radix-select-trigger-width)]">
                            <SelectItem value="인지도 확산 (도달/바이럴 중심)" className="py-3.5 px-10 font-bold focus:bg-[#F2F4F6] data-[state=checked]:text-[#333333]">인지도 확산 (도달/바이럴 중심)</SelectItem>
                            <SelectItem value="매출/프로모션 전환 (세일즈 중심)" className="py-3.5 px-10 font-bold focus:bg-[#F2F4F6] data-[state=checked]:text-[#333333]">매출/프로모션 전환 (세일즈 중심)</SelectItem>
                            <SelectItem value="고객 참여 유도 (댓글/이벤트 중심)" className="py-3.5 px-10 font-bold focus:bg-[#F2F4F6] data-[state=checked]:text-[#333333]">고객 참여 유도 (댓글/이벤트 중심)</SelectItem>
                            <SelectItem value="브랜드 충성도/팬덤 강화 (정보성/소통 중심)" className="py-3.5 px-10 font-bold focus:bg-[#F2F4F6] data-[state=checked]:text-[#333333]">브랜드 충성도/팬덤 강화 (소통 중심)</SelectItem>
                            <SelectItem value="웹사이트/앱 트래픽 유입" className="py-3.5 px-10 font-bold focus:bg-[#F2F4F6] data-[state=checked]:text-[#333333]">웹사이트/앱 트래픽 유입</SelectItem>
                        </SelectContent>
                    </Select>
                </div>
            </div>
