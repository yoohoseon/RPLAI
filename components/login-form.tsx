        ...
        <div className="w-full max-w-md animate-in fade-in slide-in-from-bottom-4 duration-700">
            <div className="bg-white border-none rounded-[32px] p-10 shadow-[0_12px_40px_rgba(0,0,0,0.06)] relative overflow-hidden">
                <div className="mb-10 text-center">
                    <div className="inline-flex items-center justify-center w-16 h-16 rounded-3xl bg-[#F2F4F6]/5 text-[#333D4B] mb-6">
                    ...
                    <h1 className="text-[26px] font-bold tracking-tight text-[#333D4B] mb-2.5">로그인</h1>
                    ...
                    >
                        {isPending ? (
                            <div className="flex items-center gap-2">
                                <svg className="animate-spin h-5 w-5 text-[#333D4B]" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
